...
class Bankdetails{
  ...
  late String balance,phone,eyeColor, name,gender,company,email,address;
   ...
   Bankdetails({required this.isActive,required this.balance,required this.age,required this.eyeColor,required this.name,required this.gender,required this.company,required this.email,required this.phone,required this.address});
}
List bankData = [
  {
    "isActive": false,
...
void main()
{
   ...
   {
    BankdetailsModel b1=BankdetailsModel.fromBankdetails(Bankdetails: bankData[i]);

  BankdetailsList.add(b1);
   }
   for(int i=0;i<BankdetailsList.length;i++)
   {
    print('isActive:${BankdetailsList[i].isActive}'+'balance:${BankdetailsList[i].balance}'+'age"${BankdetailsList[i].age}'+'eyeColor:${BankdetailsList[i].eyeColor}'+'name:${BankdetailsList[i].name}'+'gender:${BankdetailsList[i].gender}'+'company:${BankdetailsList[i].company}'+'email:${BankdetailsList[i].email}'+'phone:${BankdetailsList[i].phone}'+'address:${BankdetailsList[i].address}');
   }
}
